...
In Lean, however, a relation on $M$ is defined as a function $M \to M \to $~{\ttfamily Prop}.
...
A \href{https://github.com/pedro-nunez/lean-algebra-2021/blob/master/equivalence-relation/solution.lean}{solution} is available on the repository
\begin{center}
